...
public class Hanoi {
	...
	public void moveOneRing(int from, int to) {
		/* TODO */
		// Pops the ring from the tower you want to move it from and puts it into the tower you want to put it to
	...
	public void movePile(int n, int from, int to, int via) {
		/* TODO */
		// Default cause when there is only 1 ring on the tower
		if (n == 1)
		{
			moveOneRing(from, to);
		}
